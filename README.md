...
A small case every day to strengthen your python skills.
...
2. Enter the JetBrains `Activation code`.
...
- `Add Python Interpreter` in the lower right corner.
- Select `Conda Environment`.
- Select `Use existing environment`.

![image-20250107154648182](assets/image-20250107154648182.png)
